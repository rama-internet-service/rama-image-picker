  ...
  private FakeR fakeR;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!isCameraOnly) {
          ...
          setContentView(fakeR.getId("layout", "ef_activity_image_picker"));
        ...
        if (savedInstanceState != null) {
          ...
          imagePickerFragment = (ImagePickerFragment) getSupportFragmentManager().findFragmentById(fakeR.getId("id", "ef_imagepicker_fragment_placeholder"));
          ...
          ft.replace( fakeR.getId("id", "ef_imagepicker_fragment_placeholder"), imagePickerFragment);
    ...
    private FrameLayout createCameraLayout() {
      ...
      frameLayout.setId(fakeR.getId("id", "ef_imagepicker_fragment_placeholder"));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
      ...
      getMenuInflater().inflate(fakeR.getId("menu", "ef_image_picker_menu_main"), menu);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
      ...
      MenuItem menuCamera = menu.findItem(fakeR.getId("id", "menu_camera"));
      ...
      MenuItem menuDone = menu.findItem(fakeR.getId("id", "menu_done"));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
      ...
      if (id == fakeR.getId("id", "menu_done")) {
            imagePickerFragment.onDone();
            return true;
        }
        //if (id == R.id.menu_camera) {
      if (id == fakeR.getId("id", "menu_camera")) {
    ...
    private void setupView() {
      ...
      Toolbar toolbar = findViewById(fakeR.getId("id", "toolbar"));
