    ...
    public FolderViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      fakeR = new FakeR(getContext());
        return new FolderViewHolder(
          ...
          getInflater().inflate(fakeR.getId("layout", "ef_imagepicker_item_folder"), parent, false));
    ...
    static class FolderViewHolder extends RecyclerView.ViewHolder {
      private FakeR fakeR;
        ...
        FolderViewHolder(View itemView) {
          ...
          image = (ImageView) itemView.findViewById(fakeR.getId("id", "image"));

           // name = (TextView) itemView.findViewById(R.id.tv_name);
          name = (TextView) itemView.findViewById(fakeR.getId("id", "tv_name"));
           // number = (TextView) itemView.findViewById(R.id.tv_number);
          number = (TextView) itemView.findViewById(fakeR.getId("id", "tv_number"));
        }
    }
}
